...
export namespace CompanionTransientIndexNS {
  export type CompanionTransientIndex = {
...
export type Index = CompanionTransientIndexNS.CompanionTransientIndex;

export namespace CompanionTransientNS {
  export type CompanionTransient = {
    Attack:                      number;
    Defense:                     number;
    Description:                 string;
...
export type CompanionTransient = CompanionTransientNS.CompanionTransient;
