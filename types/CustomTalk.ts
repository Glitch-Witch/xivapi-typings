...
export namespace CustomTalkIndexNS {
  export type CustomTalkIndex = {
...
export type Index = CustomTalkIndexNS.CustomTalkIndex;

export namespace CustomTalkNS {
...
export type CustomTalk = CustomTalkNS.CustomTalk;
