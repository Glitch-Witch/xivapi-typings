...
export namespace YKWIndexNS {
  export type YKWIndex = {
...
export type Index = YKWIndexNS.YKWIndex;

export namespace YKWNS {
  export type Ykw = {
    ...
    ItemTargetID:      number;
    Location0:         Location;
    Location0Target:   string;
    Location0TargetID: number;
    Location1:         Location;
    Location1Target:   string;
    Location1TargetID: number;
    Location2:         Location;
    Location2Target:   string;
    Location2TargetID: number;
    Patch:             number;
    Url:               string;
  }
