...
export namespace EventActionIndexNS {
  export type EventActionIndex = {
...
export type Index = EventActionIndexNS.EventActionIndex;

export namespace EventActionNS {
...
export type EventAction = EventActionNS.EventAction;
