...
export namespace RacingChocoboItemIndexNS {
  export type RacingChocoboItemIndex = {
...
export type Index = RacingChocoboItemIndexNS.RacingChocoboItemIndex;

export namespace RacingChocoboItemNS {
  export type RacingChocoboItem = {
    Category:         number;
...
export type RacingChocoboItem = RacingChocoboItemNS.RacingChocoboItem;
