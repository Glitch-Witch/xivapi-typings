...
export namespace AetherCurrentCompFlgSetIndexNS {
  export type AetherCurrentCompFlgSetIndex = {
...
export type Index = AetherCurrentCompFlgSetIndexNS.AetherCurrentCompFlgSetIndex;

export namespace AetherCurrentCompFlgSetNS {
  ...
  export type TerritoryTypeClass = {
    AchievementIndex:      string;
    "AddedIn5-3":          number;
    Aetheryte:             number;
...
export type AetherCurrentCompFlgSet = AetherCurrentCompFlgSetNS.AetherCurrentCompFlgSet;
