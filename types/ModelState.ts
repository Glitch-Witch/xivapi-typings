...
export namespace ModelStateIndexNS {
  export type ModelStateIndex = {
...
export type Index = ModelStateIndexNS.ModelStateIndex;

export namespace ModelStateNS {
...
export type ModelState = ModelStateNS.ModelState;
