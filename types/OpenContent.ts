...
export namespace OpenContentIndexNS {
  export type OpenContentIndex = {
...
export type Index = OpenContentIndexNS.OpenContentIndex;

export namespace OpenContentNS {
...
export type OpenContent = OpenContentNS.OpenContent;
