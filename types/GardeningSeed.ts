...
export namespace GardeningSeedIndexNS {
  export type GardeningSeedIndex = {
...
export type Index = GardeningSeedIndexNS.GardeningSeedIndex;

export namespace GardeningSeedNS {
  export type GardeningSeed = {
...
export type GardeningSeed = GardeningSeedNS.GardeningSeed;
