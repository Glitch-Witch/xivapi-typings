...
export namespace LeveRewardItemIndexNS {
  export type LeveRewardItemIndex = {
...
export type Index = LeveRewardItemIndexNS.LeveRewardItemIndex;

export namespace LeveRewardItemNS {
...
export type LeveRewardItem = LeveRewardItemNS.LeveRewardItem;
