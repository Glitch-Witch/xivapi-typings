...
export namespace IKDFishParamIndexNS {
  export type IKDFishParamIndex = {
...
export type Index = IKDFishParamIndexNS.IKDFishParamIndex;

export namespace IKDFishParamNS {
  export type IKDFishParam = {
    Fish:                    Fish;
    FishTarget:              string;
    FishTargetID:            number;
...
export type IKDFishParam = IKDFishParamNS.IKDFishParam;
