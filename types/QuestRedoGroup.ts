...
export namespace QuestRedoGroupIndexNS {
  export type QuestRedoGroupIndex = {
...
export type Index = QuestRedoGroupIndexNS.QuestRedoGroupIndex;

export namespace QuestRedoGroupNS {
  export type QuestRedoGroup = {
...
export type QuestRedoGroup = QuestRedoGroupNS.QuestRedoGroup;
