export interface GCScripShopItemIndex {
...
export interface GCScripShopItem10 {
  ...
  RequiredGrandCompanyRankTarget:   string;
  RequiredGrandCompanyRankTargetID: number;
  SortKey:                          number;
  Url:                              string;
}
...
export interface RequiredGrandCompanyRank {
  ID:                     number;
  IconFlames:             string;
  IconFlamesID:           number;
