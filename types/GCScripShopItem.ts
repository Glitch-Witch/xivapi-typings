...
export namespace GCScripShopItemIndexNS {
  export type GCScripShopItemIndex = {
...
export type Index = GCScripShopItemIndexNS.GCScripShopItemIndex;

export namespace GCScripShopItemNS {
  ...
  export type RequiredGrandCompanyRank = {
    ID:                     number;
    IconFlames:             string;
    IconFlamesID:           number;
...
export type GCScripShopItem = GCScripShopItemNS.GCScripShopItem;
