...
export namespace BuddyItemIndexNS {
  export type BuddyItemIndex = {
...
export type Index = BuddyItemIndexNS.BuddyItemIndex;

export namespace BuddyItemNS {
...
export type BuddyItem = BuddyItemNS.BuddyItem;
