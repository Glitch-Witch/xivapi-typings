...
export namespace SecretRecipeBookIndexNS {
  export type SecretRecipeBookIndex = {
...
export type Index = SecretRecipeBookIndexNS.SecretRecipeBookIndex;

export namespace SecretRecipeBookNS {
  export type SecretRecipeBook = {
...
export type SecretRecipeBook = SecretRecipeBookNS.SecretRecipeBook;
