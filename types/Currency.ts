...
export namespace CurrencyIndexNS {
  export type CurrencyIndex = {
...
export type Index = CurrencyIndexNS.CurrencyIndex;

export namespace CurrencyNS {
...
export type Currency = CurrencyNS.Currency;
