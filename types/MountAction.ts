...
export namespace MountActionIndexNS {
  export type MountActionIndex = {
...
export type Index = MountActionIndexNS.MountActionIndex;

export namespace MountActionNS {
...
export type MountAction = MountActionNS.MountAction;
