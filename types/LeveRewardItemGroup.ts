...
export namespace LeveRewardItemGroupIndexNS {
  export type LeveRewardItemGroupIndex = {
...
export type Index = LeveRewardItemGroupIndexNS.LeveRewardItemGroupIndex;

export namespace LeveRewardItemGroupNS {
  export type LeveRewardItemGroup = {
    Count0:           number;
    Count1:           number;
    Count2:           number;
    Count3:           number;
...
export type LeveRewardItemGroup = LeveRewardItemGroupNS.LeveRewardItemGroup;
