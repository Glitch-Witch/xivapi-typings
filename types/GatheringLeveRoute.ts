...
export namespace GatheringLeveRouteIndexNS {
  export type GatheringLeveRouteIndex = {
...
export type Index = GatheringLeveRouteIndexNS.GatheringLeveRouteIndex;

export namespace GatheringLeveRouteNS {
  export type GatheringLeveRoute = {
...
export type GatheringLeveRoute = GatheringLeveRouteNS.GatheringLeveRoute;
