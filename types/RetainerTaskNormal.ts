...
export namespace RetainerTaskNormalIndexNS {
  export type RetainerTaskNormalIndex = {
...
export type Index = RetainerTaskNormalIndexNS.RetainerTaskNormalIndex;

export namespace RetainerTaskNormalNS {
  export type RetainerTaskNormal = {
    FishingLog:           number;
    GameContentLinks:     any[];
    GatheringLog:         null;
    GatheringLogTarget:   string;
    GatheringLogTargetID: number;
    ID:                   number;
    Item:                 Item;
    ItemTarget:           string;
    ItemTargetID:         number;
...
export type RetainerTaskNormal = RetainerTaskNormalNS.RetainerTaskNormal;
