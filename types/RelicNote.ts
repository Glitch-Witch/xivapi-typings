...
export namespace RelicNoteIndexNS {
  export type RelicNoteIndex = {
...
export type Index = RelicNoteIndexNS.RelicNoteIndex;

export namespace RelicNoteNS {
  export type RelicNote = {
    EventItem:                        EventItem;
  ...
  export type Leve0LevelLevemete = {
    EventId:           number;
    ID:                number;
    Map:               Map;
    MapTarget:         string;
  ...
  export type Leve1LevelLevemete = {
    EventId:           number;
    ID:                number;
    Map:               Map;
    MapTarget:         string;
...
export type RelicNote = RelicNoteNS.RelicNote;
