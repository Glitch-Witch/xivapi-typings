...
export namespace HairMakeTypeIndexNS {
  export type HairMakeTypeIndex = {
...
export type Index = HairMakeTypeIndexNS.HairMakeTypeIndex;

export namespace HairMakeTypeNS {
  export type HairMakeType = {
...
export type HairMakeType = HairMakeTypeNS.HairMakeType;
