...
export namespace HWDCrafterSupplyIndexNS {
  export type HWDCrafterSupplyIndex = {
...
export type Index = HWDCrafterSupplyIndexNS.HWDCrafterSupplyIndex;

export namespace HWDCrafterSupplyNS {
  ...
  export type BaseCollectableReward0 = {
    ExpReward:          number;
    ID:                 number;
    ScriptRewardAmount: number;
  }
  
  export type ItemTradeIn = {
...
export type HWDCrafterSupply = HWDCrafterSupplyNS.HWDCrafterSupply;
