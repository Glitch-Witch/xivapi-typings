...
export namespace CompanyLeveIndexNS {
  export type CompanyLeveIndex = {
...
export type Index = CompanyLeveIndexNS.CompanyLeveIndex;

export namespace CompanyLeveNS {
  export type CompanyLeve = {
    ...
    Patch:                  number;
    RoutePointTime0:        number;
    RoutePointTime1:        number;
    RoutePointTime2:        number;
    RoutePointTime3:        number;
    RoutePointTime4:        number;
    RoutePointTime5:        number;
    RoutePointTime6:        number;
    RoutePointTime7:        number;
    Rule:                   null;
    RuleParam:              number;
    RuleTarget:             string;
    RuleTargetID:           number;
...
export type CompanyLeve = CompanyLeveNS.CompanyLeve;
