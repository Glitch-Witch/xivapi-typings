...
export namespace MobHuntOrderTypeIndexNS {
  export type MobHuntOrderTypeIndex = {
...
export type Index = MobHuntOrderTypeIndexNS.MobHuntOrderTypeIndex;

export namespace MobHuntOrderTypeNS {
  export type MobHuntOrderType = {
    EventItem:          EventItem;
...
export type MobHuntOrderType = MobHuntOrderTypeNS.MobHuntOrderType;
