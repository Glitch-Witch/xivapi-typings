...
export namespace AozActionIndexNS {
  export type AozActionIndex = {
...
export type Index = AozActionIndexNS.AozActionIndex;

export namespace AozActionNS {
  export type AozAction = {
    Action:           Action;
    ActionTarget:     string;
  ...
  export type ClassJob = {
    ...
    UIPriority:                 number;
    UnlockQuest:                { [key: string]: number | string };
...
export type AozAction = AozActionNS.AozAction;
