...
export namespace IKDSpotIndexNS {
  export type IKDSpotIndex = {
...
export type Index = IKDSpotIndexNS.IKDSpotIndex;

export namespace IKDSpotNS {
  export type IKDSpot = {
...
export type IKDSpot = IKDSpotNS.IKDSpot;
