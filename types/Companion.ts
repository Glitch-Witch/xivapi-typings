...
export namespace CompanionIndexNS {
...
export type Index = CompanionIndexNS.CompanionIndex;

export namespace CompanionNS {
...
export type Companion = CompanionNS.Companion;
