...
export namespace GilShopItemIndexNS {
  export type GilShopItemIndex = {
...
export type Index = GilShopItemIndexNS.GilShopItemIndex;

export namespace GilShopItemNS {
  export type GilShopItem = {
...
export type GilShopItem = GilShopItemNS.GilShopItem;
