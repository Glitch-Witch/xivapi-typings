...
export namespace DescriptionPageIndexNS {
  export type DescriptionPageIndex = {
...
export type Index = DescriptionPageIndexNS.DescriptionPageIndex;

export namespace DescriptionPageNS {
...
export type DescriptionPage = DescriptionPageNS.DescriptionPage;
