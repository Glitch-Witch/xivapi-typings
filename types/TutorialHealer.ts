...
export namespace TutorialHealerIndexNS {
  export type TutorialHealerIndex = {
...
export type Index = TutorialHealerIndexNS.TutorialHealerIndex;

export namespace TutorialHealerNS {
  export type TutorialHealer = {
    GameContentLinks:  any[];
    ID:                number;
    Objective:         TutorialHealerObjective;
  ...
  export type TutorialHealerObjective = {
    Exp:                  number;
    Gil:                  number;
    ID:                   number;
...
export type TutorialHealer = TutorialHealerNS.TutorialHealer;
