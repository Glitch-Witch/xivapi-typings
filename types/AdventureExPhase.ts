...
export namespace AdventureExPhaseIndexNS {
  export type AdventureExPhaseIndex = {
...
export type Index = AdventureExPhaseIndexNS.AdventureExPhaseIndex;

export namespace AdventureExPhaseNS {
  export type AdventureExPhase = {
  ...
  export type AdventureBeginLevel = {
    EventId:           number;
    ID:                number;
    Map:               PurpleMap;
    MapTarget:         string;
...
export type AdventureExPhase = AdventureExPhaseNS.AdventureExPhase;
