...
export namespace QuestClassJobRewardIndexNS {
  export type QuestClassJobRewardIndex = {
...
export type Index = QuestClassJobRewardIndexNS.QuestClassJobRewardIndex;

export namespace QuestClassJobRewardNS {
  export type QuestClassJobReward = {
...
export type QuestClassJobReward = QuestClassJobRewardNS.QuestClassJobReward;
