...
export namespace MobHuntOrderIndexNS {
  export type MobHuntOrderIndex = {
...
export type Index = MobHuntOrderIndexNS.MobHuntOrderIndex;

export namespace MobHuntOrderNS {
...
export type MobHuntOrder = MobHuntOrderNS.MobHuntOrder;
