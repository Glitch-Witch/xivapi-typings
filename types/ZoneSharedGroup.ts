...
export namespace ZoneSharedGroupIndexNS {
  export type ZoneSharedGroupIndex = {
...
export type Index = ZoneSharedGroupIndexNS.ZoneSharedGroupIndex;

export namespace ZoneSharedGroupNS {
  export type ZoneSharedGroup = {
...
export type ZoneSharedGroup = ZoneSharedGroupNS.ZoneSharedGroup;
