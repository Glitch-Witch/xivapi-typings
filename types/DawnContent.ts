...
export namespace DawnContentIndexNS {
  export type DawnContentIndex = {
...
export type Index = DawnContentIndexNS.DawnContentIndex;

export namespace DawnContentNS {
  export type DawnContent = {
    Content:          Content;
...
export type DawnContent = DawnContentNS.DawnContent;
