...
export namespace TomestonesItemIndexNS {
  export type TomestonesItemIndex = {
...
export type Index = TomestonesItemIndexNS.TomestonesItemIndex;

export namespace TomestonesItemNS {
  export type TomestonesItem = {
    ...
    Patch:              null;
    Tomestones:         null;
    TomestonesTarget:   string;
    TomestonesTargetID: number;
    Url:                string;
  }
...
export type TomestonesItem = TomestonesItemNS.TomestonesItem;
