...
export namespace CraftActionIndexNS {
  export type CraftActionIndex = {
...
export type Index = CraftActionIndexNS.CraftActionIndex;

export namespace CraftActionNS {
...
export type CraftAction = CraftActionNS.CraftAction;
