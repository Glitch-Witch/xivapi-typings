...
export namespace WeatherRateIndexNS {
  export type WeatherRateIndex = {
...
export type Index = WeatherRateIndexNS.WeatherRateIndex;

export namespace WeatherRateNS {
...
export type WeatherRate = WeatherRateNS.WeatherRate;
