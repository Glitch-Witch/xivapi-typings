...
export namespace TripleTriadIndexNS {
  export type TripleTriadIndex = {
...
export type Index = TripleTriadIndexNS.TripleTriadIndex;

export namespace TripleTriadNS {
...
export type TripleTriad = TripleTriadNS.TripleTriad;
