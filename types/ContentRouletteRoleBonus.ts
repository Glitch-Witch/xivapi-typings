...
export namespace ContentRouletteRoleBonusIndexNS {
  export type ContentRouletteRoleBonusIndex = {
...
export type Index = ContentRouletteRoleBonusIndexNS.ContentRouletteRoleBonusIndex;

export namespace ContentRouletteRoleBonusNS {
  export type ContentRouletteRoleBonus = {
    GameContentLinks:       GameContentLinks;
    ID:                     number;
    ItemRewardType:         ItemRewardType;
    ItemRewardTypeTarget:   string;
    ItemRewardTypeTargetID: number;
    Patch:                  null;
    RewardAmount:           number;
    Url:                    string;
  }
  ...
  export type ContentRoulette = {
    ContentRouletteRoleBonus: number[];
  }
...
export type ContentRouletteRoleBonus = ContentRouletteRoleBonusNS.ContentRouletteRoleBonus;
