...
export namespace DeepDungeonIndexNS {
  export type DeepDungeonIndex = {
...
export type Index = DeepDungeonIndexNS.DeepDungeonIndex;

export namespace DeepDungeonNS {
...
export type DeepDungeon = DeepDungeonNS.DeepDungeon;
