...
export namespace DeepDungeonMap5XIndexNS {
  export type DeepDungeonMapXIndex = {
...
export type Index = DeepDungeonMap5XIndexNS.DeepDungeonMapXIndex;

export namespace DeepDungeonMap5XNS {
  export type DeepDungeonMapX = {
...
export type DeepDungeonMap5X = DeepDungeonMap5XNS.DeepDungeonMapX;
