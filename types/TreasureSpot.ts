...
export namespace TreasureSpotIndexNS {
  export type TreasureSpotIndex = {
...
export type Index = TreasureSpotIndexNS.TreasureSpotIndex;

export namespace TreasureSpotNS {
...
export type TreasureSpot = TreasureSpotNS.TreasureSpot;
