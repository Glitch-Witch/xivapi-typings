...
export namespace StainTransientIndexNS {
  export type StainTransientIndex = {
...
export type Index = StainTransientIndexNS.StainTransientIndex;

export namespace StainTransientNS {
  export type StainTransient = {
...
export type StainTransient = StainTransientNS.StainTransient;
