...
export namespace FishParameterIndexNS {
  export type FishParameterIndex = {
...
export type Index = FishParameterIndexNS.FishParameterIndex;

export namespace FishParameterNS {
...
export type FishParameter = FishParameterNS.FishParameter;
