...
export namespace FateTokenTypeIndexNS {
  export type FateTokenTypeIndex = {
...
export type Index = FateTokenTypeIndexNS.FateTokenTypeIndex;

export namespace FateTokenTypeNS {
  export type FateTokenType = {
    Currency:         Currency;
...
export type FateTokenType = FateTokenTypeNS.FateTokenType;
