...
export namespace CreditIndexNS {
  export type CreditIndex = {
...
export type Index = CreditIndexNS.CreditIndex;

export namespace CreditNS {
  export type Credit = {
    EnglishCast1:          null;
...
export type Credit = CreditNS.Credit;
