...
export namespace ContentsNoteIndexNS {
  export type ContentsNoteIndex = {
...
export type Index = ContentsNoteIndexNS.ContentsNoteIndex;

export namespace ContentsNoteNS {
...
export type ContentsNote = ContentsNoteNS.ContentsNote;
