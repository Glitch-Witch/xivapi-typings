...
export namespace LotteryExchangeShopIndexNS {
  export type LotteryExchangeShopIndex = {
...
export type Index = LotteryExchangeShopIndexNS.LotteryExchangeShopIndex;

export namespace LotteryExchangeShopNS {
  export type LotteryExchangeShop = {
...
export type LotteryExchangeShop = LotteryExchangeShopNS.LotteryExchangeShop;
