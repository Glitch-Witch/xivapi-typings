...
export namespace CompanyCraftPartIndexNS {
  export type CompanyCraftPartIndex = {
...
export type Index = CompanyCraftPartIndexNS.CompanyCraftPartIndex;

export namespace CompanyCraftPartNS {
...
export type CompanyCraftPart = CompanyCraftPartNS.CompanyCraftPart;
