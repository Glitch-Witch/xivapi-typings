...
export namespace PvPActionSortIndexNS {
  export type PVPActionSortIndex = {
...
export type Index = PvPActionSortIndexNS.PVPActionSortIndex;

export namespace PvPActionSortNS {
  export type PVPActionSort = {
    Action:           Action;
    ActionTarget:     string;
...
export type PvPActionSort = PvPActionSortNS.PVPActionSort;
