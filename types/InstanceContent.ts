...
export namespace InstanceContentIndexNS {
  export type InstanceContentIndex = {
...
export type Index = InstanceContentIndexNS.InstanceContentIndex;

export namespace InstanceContentNS {
  ...
  export type GameContentLinks = {
    InstanceContent:        InstanceContentClass;
    InstanceContentCSBonus: InstanceContentCSBonusClass;
    InstanceContentGuide:   InstanceContentCSBonusClass;
  }
  
  export type InstanceContentClass = {
    ReqInstance: number[];
  }
  
  export type InstanceContentCSBonusClass = {
    Instance: number[];
  }
...
export type InstanceContent = InstanceContentNS.InstanceContent;
