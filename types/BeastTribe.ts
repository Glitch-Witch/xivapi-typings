export interface BeastTribeIndex {
...
export interface BeastTribe {
  ...
  Article:                number;
  BeastRankBonus:         null;
  BeastRankBonusTarget:   string;
  BeastRankBonusTargetID: number;
  CurrencyItem:           CurrencyItem;
  CurrencyItemTarget:     string;
  CurrencyItemTargetID:   number;
  DEF:                    number;
  DisplayOrder:           number;
  Expansion:              null;
  ...
  Icon:                   string;
  IconID:                 number;
  IconReputation:         string;
  IconReputationID:       number;
  MaxRank:                number;
  MinLevel:               number;
  Name:                   string;
  NameRelation:           string;
  NameRelation_de:        string;
  NameRelation_en:        string;
  NameRelation_fr:        string;
  NameRelation_ja:        string;
  Name_de:                string;
  Name_en:                string;
  Name_fr:                string;
  Name_ja:                string;
