...
export namespace RelicIndexNS {
  export type RelicIndex = {
...
export type Index = RelicIndexNS.RelicIndex;

export namespace RelicNS {
  export type Relic = {
  ...
  export type LeveAssignmentType = {
    ID:        number;
  ...
  export type NoteSelection3Leve1 = {
    AllowanceCost:              number;
    BGM:                        Bgm;
    BGMTarget:                  Target;
    BGMTargetID:                number;
  ...
  export type Leve2LevelLevemete = {
    EventId:   number;
    ID:        number;
    Map:       number;
    Object:    number;
  ...
  export type PurpleLevelLevemete = {
    EventId:   number;
    ID:        number;
    Map:       number;
    Object:    number;
  ...
  export type LeveAssignmentTypeClass = {
    ID:               number;
    Name:             string;
    Name_de:          string;
    Name_en:          string;
...
export type Relic = RelicNS.Relic;
