...
export namespace CollectablesShopRewardScripIndexNS {
  export type CollectablesShopRewardScripIndex = {
...
export type Index = CollectablesShopRewardScripIndexNS.CollectablesShopRewardScripIndex;

export namespace CollectablesShopRewardScripNS {
  export type CollectablesShopRewardScrip = {
    Currency:         Currency;
  ...
  export type CollectablesShopItem = {
    CollectablesShopRewardScrip: string[];
  }
  
}

export type CollectablesShopRewardScrip = CollectablesShopRewardScripNS.CollectablesShopRewardScrip;
