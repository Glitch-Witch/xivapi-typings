...
export namespace GatheringPointIndexNS {
  export type GatheringPointIndex = {
...
export type Index = GatheringPointIndexNS.GatheringPointIndex;

export namespace GatheringPointNS {
  export type GatheringPoint = {
    Count:                        number;
    GameContentLinks:             any[];
    GamePatch:                    GatheringPointGamePatch;
  ...
  export type GatheringPointGamePatch = {
    Banner:      string;
    ExName:      string;
    ExVersion:   number;
    ID:          number;
  ...
  export type GatheringPointTransientGamePatch = {
    Banner:        string;
    ExName:        string;
    ExVersion:     number;
    ID:            number;
...
export type GatheringPoint = GatheringPointNS.GatheringPoint;
