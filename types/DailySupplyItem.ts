...
export namespace DailySupplyItemIndexNS {
  export type DailySupplyItemIndex = {
...
export type Index = DailySupplyItemIndexNS.DailySupplyItemIndex;

export namespace DailySupplyItemNS {
  export type DailySupplyItem = {
...
export type DailySupplyItem = DailySupplyItemNS.DailySupplyItem;
