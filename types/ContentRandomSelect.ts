...
export namespace ContentRandomSelectIndexNS {
  export type ContentRandomSelectIndex = {
...
export type Index = ContentRandomSelectIndexNS.ContentRandomSelectIndex;

export namespace ContentRandomSelectNS {
...
export type ContentRandomSelect = ContentRandomSelectNS.ContentRandomSelect;
