...
export namespace DeepDungeonItemIndexNS {
  export type DeepDungeonItemIndex = {
...
export type Index = DeepDungeonItemIndexNS.DeepDungeonItemIndex;

export namespace DeepDungeonItemNS {
  export type DeepDungeonItem = {
    Action:            Action;
    ActionTarget:      string;
...
export type DeepDungeonItem = DeepDungeonItemNS.DeepDungeonItem;
