...
export namespace GcArmyExpeditionIndexNS {
  export type GcArmyExpeditionIndex = {
...
export type Index = GcArmyExpeditionIndexNS.GcArmyExpeditionIndex;

export namespace GcArmyExpeditionNS {
...
export type GcArmyExpedition = GcArmyExpeditionNS.GcArmyExpedition;
