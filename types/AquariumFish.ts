...
export namespace AquariumFishIndexNS {
  export type AquariumFishIndex = {
...
export type Index = AquariumFishIndexNS.AquariumFishIndex;

export namespace AquariumFishNS {
...
export type AquariumFish = AquariumFishNS.AquariumFish;
