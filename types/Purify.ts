...
export namespace PurifyIndexNS {
  export type PurifyIndex = {
...
export type Index = PurifyIndexNS.PurifyIndex;

export namespace PurifyNS {
  export type Purify = {
    Class:            Class;
    ClassTarget:      string;
...
export type Purify = PurifyNS.Purify;
