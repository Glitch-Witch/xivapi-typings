...
export namespace BNpcCustomizeIndexNS {
  export type BNpcCustomizeIndex = {
...
export type Index = BNpcCustomizeIndexNS.BNpcCustomizeIndex;

export namespace BNpcCustomizeNS {
...
export type BNpcCustomize = BNpcCustomizeNS.BNpcCustomize;
