...
export namespace PartyContentIndexNS {
  export type PartyContentIndex = {
...
export type Index = PartyContentIndexNS.PartyContentIndex;

export namespace PartyContentNS {
...
export type PartyContent = PartyContentNS.PartyContent;
