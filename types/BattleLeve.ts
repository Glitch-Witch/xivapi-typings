...
export namespace BattleLeveIndexNS {
  export type BattleLeveIndex = {
...
export type Index = BattleLeveIndexNS.BattleLeveIndex;

export namespace BattleLeveNS {
...
export type BattleLeve = BattleLeveNS.BattleLeve;
