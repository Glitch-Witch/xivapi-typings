...
export namespace ENpcResidentIndexNS {
  export type ENpcResidentIndex = {
...
export type Index = ENpcResidentIndexNS.ENpcResidentIndex;

export namespace ENpcResidentNS {
...
export type ENpcResident = ENpcResidentNS.ENpcResident;
