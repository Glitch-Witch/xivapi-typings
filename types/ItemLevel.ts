...
export namespace ItemLevelIndexNS {
  export type ItemLevelIndex = {
...
export type Index = ItemLevelIndexNS.ItemLevelIndex;

export namespace ItemLevelNS {
...
export type ItemLevel = ItemLevelNS.ItemLevel;
