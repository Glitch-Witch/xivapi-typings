...
export namespace TreasureIndexNS {
  export type TreasureIndex = {
...
export type Index = TreasureIndexNS.TreasureIndex;

export namespace TreasureNS {
...
export type Treasure = TreasureNS.Treasure;
