...
export namespace CharaMakeTypeIndexNS {
  export type CharaMakeTypeIndex = {
...
export type Index = CharaMakeTypeIndexNS.CharaMakeTypeIndex;

export namespace CharaMakeTypeNS {
  export type CharaMakeTypeClass = {
    ExPac?:             null;
    ExPacTarget?:       string;
...
export type CharaMakeType = CharaMakeTypeNS.CharaMakeTypeClass;
