...
export namespace GcArmyMemberGrowIndexNS {
  export type GcArmyMemberGrowIndex = {
...
export type Index = GcArmyMemberGrowIndexNS.GcArmyMemberGrowIndex;

export namespace GcArmyMemberGrowNS {
  export type GcArmyMemberGrow = {
    ClassBook:         ClassBook;
  ...
  export type ClassBook = {
    ...
    ItemSpecialBonus:           StartingTown | null;
...
export type GcArmyMemberGrow = GcArmyMemberGrowNS.GcArmyMemberGrow;
