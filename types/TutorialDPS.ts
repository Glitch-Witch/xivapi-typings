...
export namespace TutorialDPSIndexNS {
  export type TutorialDPSIndex = {
...
export type Index = TutorialDPSIndexNS.TutorialDPSIndex;

export namespace TutorialDPSNS {
  export type TutorialDPS = {
    GameContentLinks:  any[];
    ID:                number;
    Objective:         TutorialDPSObjective;
  ...
  export type TutorialDPSObjective = {
    Exp:                  number;
    Gil:                  number;
    ID:                   number;
...
export type TutorialDPS = TutorialDPSNS.TutorialDPS;
