...
export namespace DefaultTalkIndexNS {
  export type DefaultTalkIndex = {
...
export type Index = DefaultTalkIndexNS.DefaultTalkIndex;

export namespace DefaultTalkNS {
  export type DefaultTalk = {
  ...
  export type ActionTimelinePose = {
...
export type DefaultTalk = DefaultTalkNS.DefaultTalk;
