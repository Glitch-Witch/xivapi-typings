...
export namespace AetherialWheelIndexNS {
  export type AetherialWheelIndex = {
...
export type Index = AetherialWheelIndexNS.AetherialWheelIndex;

export namespace AetherialWheelNS {
  export type AetherialWheel = {
    GameContentLinks:     any[];
    Grade:                number;
    HoursRequired:        number;
    ID:                   number;
    ItemPrimed:           ItemPrimed;
    ItemPrimedTarget:     string;
    ItemPrimedTargetID:   number;
    ItemUnprimed:         ItemPrimed;
    ItemUnprimedTarget:   string;
    ItemUnprimedTargetID: number;
    Patch:                null;
    Url:                  string;
  }
  
  export type ItemPrimed = {
...
export type AetherialWheel = AetherialWheelNS.AetherialWheel;
