...
export namespace AozActionTransientIndexNS {
  export type AozActionTransientIndex = {
...
export type Index = AozActionTransientIndexNS.AozActionTransientIndex;

export namespace AozActionTransientNS {
  export type AozActionTransient = {
    Description:        string;
...
export type AozActionTransient = AozActionTransientNS.AozActionTransient;
