...
export namespace ENpcDressUpDressIndexNS {
  export type ENpcDressUpDressIndex = {
...
export type Index = ENpcDressUpDressIndexNS.ENpcDressUpDressIndex;

export namespace ENpcDressUpDressNS {
  export type ENpcDressUpDress = {
    "AddedIn5-30":       number;
    Behavior:            null;
...
export type ENpcDressUpDress = ENpcDressUpDressNS.ENpcDressUpDress;
