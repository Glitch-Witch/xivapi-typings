...
export namespace GuildOrderIndexNS {
  export type GuildOrderIndex = {
...
export type Index = GuildOrderIndexNS.GuildOrderIndex;

export namespace GuildOrderNS {
...
export type GuildOrder = GuildOrderNS.GuildOrder;
